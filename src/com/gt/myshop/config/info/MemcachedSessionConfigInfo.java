 ...
 * 
 * @author Gongtao
 * @date 2017-4-3 下午12:19:25
 * @description Memcached会话状态配置信息类
 *
 */
public class MemcachedSessionConfigInfo {
    ...
    private int sessiontimeout;			//会话状态超时时间(单位为秒)
	...
	public void setSessiontimeout(int sessiontimeout) {
		this.sessiontimeout = this.sessiontimeout=sessiontimeout>0?sessiontimeout:600;
	}
